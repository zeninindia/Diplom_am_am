...
class UiPage:
    """
    Класс для работы с UI‑элементами веб‑страницы Кинопоиск.
    """
    ...
    def __init__(self, driver, url):
        ...
        :param driver: определен через фикстуру driver
    ...
    @allure.step("Открывает первую главную страницу Кинопоиска")
    def open_site(self):
        """
    ...
    @allure.step("Клик по кнопке капчи")
    def capcha(self):
        """
        Находит и кликает капчу (если она есть).
        При отсутствии элемента — игнорирует.
        """
        try:
    ...
    @allure.step("Поиск элемента по CSS‑селектору")
    def search_by_css(self, css_selector):
        """
        Ищет элемент на странице по CSS‑селектору.
    ...
    @allure.step("Поиск элемента на странице по XPath")
    ...
    def click_element(
        ...
        for attempt in range(1, max_attempts + 1):
            with allure.step("Попытка клика по элементу"):
                try:
                    with allure.step(
        ...
        with allure.step("Не удалось кликнуть по элементу"):
